...
do
  ...
  then
    ...
    ld --relocatable -z execstack -o $M.o $OS &
    pids="$pids $!"
  fi
done
...
$CC $CFLAGS -z execstack -o Test bin/test.o $(cat gen/all.objs gen/test.objs | sed 's#^#gen/#; s#$#.o#') || exit 1
# echo "Building Hive"
