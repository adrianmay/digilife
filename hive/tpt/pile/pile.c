...
XXIndex   allocXX(XX ** pNew, bool * pRecycled) { return (XXIndex) {.i=allocInPile(headOfXXs, (void**)pNew, pRecycled, 0, 0)}; } 
XX *      getXX(XXIndex i)                      { return (XX*)findInPile(headOfXXs, i.i); } 
XX *      safeGetXX(XXIndex i)                  { return (XX*)findInPileSafe(headOfXXs, i.i); } 
